...
ActiveRecord::Schema.define(:version => 20100307073642) do
  ...
  create_table "baseball_offensive_stats", :force => true do |t|
    ...
    t.integer "defensive_interferance_reaches"
  ...
  create_table "basketball_rebounding_stats", :force => true do |t|
    ...
    t.float  "rebounds_offensive_per_game"
    t.float  "rebounds_defensive_per_game"
  end
  ...
  create_table "challenges", :force => true do |t|
    ...
    t.string   "accepted",        :limit => 3, :default => "no"
    t.integer  "league_id"
  ...
  create_table "events", :force => true do |t|
    ...
    t.string   "broadcast_listing",     :limit => 100
  end
  ...
  create_table "lines_mappings", :force => true do |t|
    t.string   "sport"
  ...
  create_table "sports_property", :force => true do |t|
    ...
    t.integer "sports_property_id",                  :null => false
  ...
  create_table "stats_mappings", :force => true do |t|
    ...
    t.string   "counter_field", :limit => 100
    t.integer  "priority"
  end
  ...
  create_table "users", :force => true do |t|
    ...
    t.string   "question_1"
    t.string   "answer_1",        :limit => 127
    t.string   "question_2"
    t.string   "answer_2",        :limit => 127
    t.integer  "sportbucks",                     :default => 10000
    t.string   "birthday",        :limit => 10
    t.string   "hometown"
  end

  add_index "users", ["first_name"], :name => "first_name"
  add_index "users", ["hometown"], :name => "hometown"
  add_index "users", ["last_name"], :name => "last_name"
  add_index "users", ["middle_name"], :name => "middle_name"
